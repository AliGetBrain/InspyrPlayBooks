...
const subject = `Invoice #{{invoiceNumber}}- Client: {{contactCompanyName}}, Past Due Reminder`;
   ...
   <!-- Header -->
    <div style="margin-bottom: 12px; background: {{primaryColor}}; border-radius: 8px 8px 0 0; padding: 15px; text-align: center; font-family: Arial, Helvetica, sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    <h1 style="color: white; margin: 0; font-size: 1.5rem; font-weight: 600; letter-spacing: 0.025em;">OVERDUE INVOICE REMINDER</h1>
...
function generateAndSaveHTML() {
  try {
    ...
    const outputFile = path.join(__dirname, "./html_output/invoice6.html");
